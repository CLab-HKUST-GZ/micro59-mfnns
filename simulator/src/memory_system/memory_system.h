  ...
  public:
    virtual void connect_frontend(IFrontEnd* frontend) { 
      ...
      for (auto component : m_components) {
        ...
        // printf("IMemorySystem::connect_frontend component:%s\n",component->get_id().c_str());
        // fflush(stdout);
      }
    };
    ...
    virtual int get_num_read() { return 0; };
    virtual int get_num_write() { return 0; };
    virtual size_t get_num_rd() { return 0; };
    virtual size_t get_num_wr() { return 0; };
    virtual size_t get_num_act() { return 0; };
    virtual size_t get_num_pre() { return 0; };
};
