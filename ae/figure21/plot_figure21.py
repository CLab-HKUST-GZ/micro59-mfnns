...
DEFAULT_SOURCE_TSV = SCRIPT_DIR / "data" / "figure21_sweep_results.tsv"
DEFAULT_ANSMET_STATS_DIR = SCRIPT_DIR / "data" / "ansmet_stats"
DEFAULT_SAVE_PREFIX = "output/figure21"
DEFAULT_DATA_TSV = SCRIPT_DIR / "output" / "figure21_plot_data.tsv"
